...
from reportable_app.core.db import Base
from reportable_app.apps.files.models import *
from reportable_app.apps.file_analysis.models import *

from reportable_app.settings import settings
